 ...
 * 
 * Handles appointment resources including retrieval, creation, and status updates
 */
...
/**
 * Extended appointment with participant details for UI
 */
...
/**
 * Get formatted display information for appointment status
 */
