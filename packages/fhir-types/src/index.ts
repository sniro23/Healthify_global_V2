...
export interface Duration extends Quantity {
  // Duration is a specialization of Quantity without any additional fields
}

export interface Age extends Quantity {
  // Age is a specialization of Quantity without any additional fields
}

export interface Count extends Quantity {
  // Count is a specialization of Quantity without any additional fields
}

export interface Distance extends Quantity {
  // Distance is a specialization of Quantity without any additional fields
}

export interface Money extends Quantity {
  // Money is a specialization of Quantity without any additional fields
} 